...
module.exports = {
   ...
   * Si no se encuentra definido en la variable de entorno `PORT`, se utiliza el puerto por defecto `8000`.
   * @example
   ...
   * Si no se encuentra definida en la variable de entorno `MONGODB_URI`, se utiliza la URI por defecto `mongodb://127.0.0.1:27017/auth-db`.
   * @example
   * // Para definir la URI en el entorno:
   * process.env.MONGODB_URI = "mongodb+srv://user:password@cluster.mongodb.net/mydatabase";
   */
  mongodb_uri: process.env.MONGODB_URI || "mongodb://127.0.0.1:27017/auth-db",
};
